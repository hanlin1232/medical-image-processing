...
function checkRowIndex(matrix, index, outer) {
  var max2 = outer ? matrix.rows : matrix.rows - 1;
  if (index < 0 || index > max2) {
    throw new RangeError("Row index out of range");
  }
}
function checkColumnIndex(matrix, index, outer) {
  var max2 = outer ? matrix.columns : matrix.columns - 1;
  if (index < 0 || index > max2) {
...
function AbstractMatrix(superCtor) {
  ...
  class Matrix2 extends superCtor {
    static get [Symbol.species]() {
      return this;
    }
    /**
    ...
    static eye(rows, columns, value) {
      ...
      var min2 = Math.min(rows, columns);
    ...
    static diag(data, rows, columns) {
      ...
      if (columns === void 0) columns = rows;
      var min2 = Math.min(l, rows, columns);
      var matrix = this.zeros(rows, columns);
      for (var i2 = 0; i2 < min2; i2++) {
    ...
    static checkMatrix(value) {
      return Matrix2.isMatrix(value) ? value : new this(value);
    }
    /**
    ...
    repeat(rowRep, colRep) {
      ...
      for (var i2 = 0; i2 < rowRep; i2++) {
        for (var j = 0; j < colRep; j++) {
          matrix.setSubMatrix(this, this.rows * i2, this.columns * j);
        }
      }
      return matrix;
    }
    ...
    /**
         ...
         */
    diag() {
      var min2 = Math.min(this.rows, this.columns);
      var diag = new Array(min2);
      for (var i2 = 0; i2 < min2; i2++) {
    ...
    /**
         ...
         */
    dot(vector2) {
      if (Matrix2.isMatrix(vector2)) vector2 = vector2.to1DArray();
    ...
    mmulStrassen(y) {
      ...
      function embed(mat, rows, cols) {
        ...
        if (r3 === rows && c3 === cols) {
          ...
          var resultat = Matrix2.zeros(rows, cols);
      ...
      function blockMult(a, b, rows, cols) {
        ...
        var m1 = blockMult(Matrix2.add(a11, a22), Matrix2.add(b11, b22), halfRows, halfCols);
        var m2 = blockMult(Matrix2.add(a21, a22), b11, halfRows, halfCols);
        var m3 = blockMult(a11, Matrix2.sub(b12, b22), halfRows, halfCols);
        var m4 = blockMult(a22, Matrix2.sub(b21, b11), halfRows, halfCols);
        var m5 = blockMult(Matrix2.add(a11, a12), b22, halfRows, halfCols);
        var m6 = blockMult(Matrix2.sub(a21, a11), Matrix2.add(b11, b12), halfRows, halfCols);
        var m7 = blockMult(Matrix2.sub(a12, a22), Matrix2.add(b21, b22), halfRows, halfCols);
        var c11 = Matrix2.add(m1, m4);
        c11.sub(m5);
        c11.add(m7);
        var c12 = Matrix2.add(m3, m5);
        var c21 = Matrix2.add(m2, m4);
        var c22 = Matrix2.sub(m1, m2);
        c22.add(m3);
        c22.add(m6);
        var resultat = Matrix2.zeros(2 * c11.rows, 2 * c11.columns);
    ...
    scaleRows(min2, max2) {
      ...
      for (var i2 = 0; i2 < this.rows; i2++) {
        var scaled = rescale(this.getRow(i2), { min: min2, max: max2 });
    ...
    setSubMatrix(matrix, startRow, startColumn) {
      ...
      checkRange(this, startRow, endRow, startColumn, endColumn);
      for (var i2 = 0; i2 < matrix.rows; i2++) {
        for (var j = 0; j < matrix.columns; j++) {
          this[startRow + i2][startColumn + j] = matrix.get(i2, j);
        }
      }
      return this;
    }
  ...
  Matrix2.prototype.klass = "Matrix";
  function compareNumbers(a, b) {
    return a - b;
  }
  Matrix2.random = Matrix2.rand;
  Matrix2.diagonal = Matrix2.diag;
  Matrix2.prototype.diagonal = Matrix2.prototype.diag;
  Matrix2.identity = Matrix2.eye;
  Matrix2.prototype.negate = Matrix2.prototype.neg;
  Matrix2.prototype.tensorProduct = Matrix2.prototype.kroneckerProduct;
  Matrix2.prototype.determinant = Matrix2.prototype.det;
  var inplaceOperator = `
(function %name%(value) {
...
`;
  ...
  for (var operator of operators) {
    ...
    for (i = 1; i < operator.length; i++) {
      Matrix2.prototype[operator[i]] = inplaceOp;
      Matrix2.prototype[`${operator[i]}S`] = inplaceOpS;
      Matrix2.prototype[`${operator[i]}M`] = inplaceOpM;
      Matrix2[operator[i]] = staticOp;
    }
  }
  var methods = [["~", "not"]];
  [
  ...
  for (var method of methods) {
    ...
    for (i = 1; i < method.length; i++) {
      Matrix2.prototype[method[i]] = inplaceMeth;
      Matrix2[method[i]] = staticMeth;
    }
  }
  ...
  for (var methodWithArg of methodsWithArgs) {
    ...
    if (methodWithArg[1] !== 1) {
      ...
      for (i = 2; i < methodWithArg.length; i++) {
        Matrix2.prototype[methodWithArg[i]] = inplaceMethWithArgs;
        Matrix2[methodWithArg[i]] = staticMethWithArgs;
      }
    } else {
      var tmplVar = {
        name: methodWithArg[2],
      ...
      for (i = 2; i < methodWithArg.length; i++) {
        Matrix2.prototype[methodWithArg[i]] = inplaceMethod2;
        Matrix2.prototype[`${methodWithArg[i]}M`] = inplaceMethodM;
        Matrix2.prototype[`${methodWithArg[i]}S`] = inplaceMethodS;
        Matrix2[methodWithArg[i]] = staticMethod2;
      }
    }
  }
...
var init_matrix = __esm({
  "node_modules/ml-matrix/src/matrix.js"() {
    init_abstractMatrix();
    init_util2();
    Matrix = class _Matrix extends AbstractMatrix(Array) {
...
function linearDependencies(matrix, options = {}) {
  ...
  for (var i = 0; i < n; i++) {
    ...
    var x = svd.solve(b);
    var error = max(
      Matrix.sub(b, Abis.mmul(x)).abs().to1DArray()
    );
    results.setRow(
      i,
...
// node_modules/ml-kernel-gaussian/node_modules/ml-distance-euclidean/lib-es6/euclidean.js
...
var require_anova_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/anova-kernel.js"(exports, module) {
    "use strict";
    var defaultOptions = {
      sigma: 1,
      degree: 1
...
// node_modules/ml-distance-euclidean/euclidean.js
var require_euclidean = __commonJS({
  "node_modules/ml-distance-euclidean/euclidean.js"(exports, module) {
    "use strict";
    function squaredEuclidean2(p, q) {
      var d = 0;
    ...
    euclidean2.squared = squaredEuclidean2;
  }
});

// node_modules/ml-kernel/src/kernels/cauchy-kernel.js
var require_cauchy_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/cauchy-kernel.js"(exports, module) {
    "use strict";
    var squaredEuclidean2 = require_euclidean().squared;
    var defaultOptions = {
      sigma: 1
    };
...
var require_exponential_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/exponential-kernel.js"(exports, module) {
    "use strict";
    var euclidean2 = require_euclidean();
    var defaultOptions = {
      sigma: 1
    };
...
var require_histogram_intersection_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/histogram-intersection-kernel.js"(exports, module) {
    "use strict";
...
var require_laplacian_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/laplacian-kernel.js"(exports, module) {
    "use strict";
    var euclidean2 = require_euclidean();
    var defaultOptions = {
      sigma: 1
...
var require_multiquadratic_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/multiquadratic-kernel.js"(exports, module) {
    "use strict";
    var squaredEuclidean2 = require_euclidean().squared;
    var defaultOptions = {
      constant: 1
...
var require_rational_quadratic_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernels/rational-quadratic-kernel.js"(exports, module) {
    "use strict";
    var squaredEuclidean2 = require_euclidean().squared;
    var defaultOptions = {
      constant: 1
...
var require_kernel = __commonJS({
  "node_modules/ml-kernel/src/kernel.js"(exports, module) {
    "use strict";
    var Matrix2 = (init_src(), __toCommonJS(src_exports)).Matrix;
    ...
    var Kernel = class {
      ...
      compute(inputs, landmarks) {
        ...
        if (this.kernelType === "linear") {
          var matrix = new Matrix2(inputs);
          return matrix.mmul(new Matrix2(landmarks).transposeView());
        }
        const kernelMatrix = new Matrix2(inputs.length, landmarks.length);
        var i, j;
        if (inputs === landmarks) {
...
var require_array = __commonJS({
  "node_modules/ml-stat/array.js"(exports) {
    ...
    exports.max = function max2(values) {
      var max3 = values[0];
      var l = values.length;
      for (var i = 1; i < l; i++) {
        if (values[i] > max3) max3 = values[i];
      }
      return max3;
    };
    exports.min = function min2(values) {
      var min3 = values[0];
      var l = values.length;
      for (var i = 1; i < l; i++) {
        if (values[i] < min3) min3 = values[i];
      }
      return min3;
    };
...
var require_matrix = __commonJS({
  "node_modules/ml-stat/matrix.js"(exports) {
    ...
    exports.max = function max2(matrix) {
      var max3 = -Infinity;
      for (var i = 0; i < matrix.length; i++) {
        for (var j = 0; j < matrix[i].length; j++) {
          if (matrix[i][j] > max3) max3 = matrix[i][j];
        }
      }
      return max3;
    };
    exports.min = function min2(matrix) {
      var min3 = Infinity;
      for (var i = 0; i < matrix.length; i++) {
        for (var j = 0; j < matrix[i].length; j++) {
          if (matrix[i][j] < min3) min3 = matrix[i][j];
        }
      }
      return min3;
    };
    ...
    exports.mean = function mean(matrix, dimension) {
      ...
      var rows = matrix.length, cols = matrix[0].length, theMean, N, i, j;
      if (dimension === -1) {
        theMean = [0];
        N = rows * cols;
        for (i = 0; i < rows; i++) {
    ...
    exports.sum = function sum(matrix, dimension) {
      ...
      var rows = matrix.length, cols = matrix[0].length, theSum, i, j;
      if (dimension === -1) {
        theSum = [0];
        for (i = 0; i < rows; i++) {
          for (j = 0; j < cols; j++) {
    ...
    exports.product = function product(matrix, dimension) {
      ...
      var rows = matrix.length, cols = matrix[0].length, theProduct, i, j;
      if (dimension === -1) {
        theProduct = [1];
        for (i = 0; i < rows; i++) {
          for (j = 0; j < cols; j++) {
    ...
    exports.mode = function mode(matrix) {
      var rows = matrix.length, cols = matrix[0].length, modes = new Array(cols), i, j;
      for (i = 0; i < cols; i++) {
    ...
    exports.covariance = function covariance(matrix, dimension) {
      return exports.scatter(matrix, void 0, dimension);
    };
    exports.scatter = function scatter(matrix, divisor, dimension) {
      ...
      var cols = matrix[0].length, cov, i, j, s, k;
      if (dimension === 0) {
        cov = new Array(cols);
        for (i = 0; i < cols; i++) {
    ...
    exports.correlation = function correlation(matrix) {
      var means = exports.mean(matrix), standardDeviations = exports.standardDeviation(matrix, true, means), scores = exports.zScores(matrix, means, standardDeviations), rows = matrix.length, cols = matrix[0].length, i, j;
    ...
    exports.center = function center(matrix, means, inPlace) {
      means = means || exports.mean(matrix);
      var result = matrix, l = matrix.length, i, j, jj;
      if (!inPlace) {
        result = new Array(l);
        for (i = 0; i < l; i++) {
    ...
    exports.weightedMean = function weightedMean(matrix, weights, dimension) {
      ...
      var rows = matrix.length;
      if (rows === 0) return [];
      var cols = matrix[0].length, means, i, ii, j, w, row;
      if (dimension === 0) {
    ...
    exports.weightedScatter = function weightedScatter(matrix, weights, means, factor, dimension) {
      ...
      var cols = matrix[0].length, cov, i, j, k, s;
      if (dimension === 0) {
        cov = new Array(cols);
        for (i = 0; i < cols; i++) {
          cov[i] = new Array(cols);
...
export default require_svm();
//# sourceMappingURL=ml-svm.js.map
